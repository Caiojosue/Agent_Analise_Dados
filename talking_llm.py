...
openai.api_key = "Sua chave api"  # Substitua pela sua chave real
...
class TalkingLLM():
    def __init__(
        ...
        openai_model="gpt-4o",
        whisper_size="small",
        openai_api_key="Sua chave api"  # Substitua pela sua chave real ou deixe vazio para buscar em OPENAI_API_KEY
    ):
